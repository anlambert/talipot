...
class InteractorPluginComponent : public InteractorComponent {
  ...
  public:
    ...
    */
    ...
    You have to process it and return true. If the event do nothing in your interactor : this
                ...
                */
                if (_informationWidgetItem->isVisible()) {
                    ...
                    */
                    ...
                    if (glView->glWidget()->pickNodesEdges(qMouseEv->pos().x(), qMouseEv->pos().y(),
                                                           selectedEntity)) {
...
class InteractorPlugin : public InteractorComposite {
  ...
  public:
    ...
    */
    ...
    - If the InteractorComponent don't process this event (if eventFilter function return false),
    the event is passed to the second InteractorComponent
    ...
    The second one : MouseNKeysNavigation is a standard Talipot InteractorComponent who activate
    ...
    */
    bool isCompatible(const std::string &viewName) const {
        return (viewName == "Node Link Diagram");
    }
