...
def get_sip_abi_versions():
    ...
    if sip_version >= (6, 10):
        ...
        module_source_dir = get_module_source_dir(
            (abi_major_version, abi_minor_version)
        )
            ...
            for line in vf:
                ...
                if len(parts) == 3 and parts[0] == "#define":
                    ...
                    if name == "SIP_MODULE_PATCH_VERSION":
                        ...
                        break
        sip_module_version = (
            f"{abi_major_version}.{abi_minor_version}.{abi_patch_version}"
        )
    else:
        from sipbuild.module.abi_version import (
    ...
    return abi_version, sip_module_version
...
if __name__ == "__main__":
    ...
    abi_version, sip_module_version = get_sip_abi_versions()
