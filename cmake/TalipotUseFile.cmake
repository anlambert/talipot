...
MACRO(TALIPOT_SET_COMPILER_OPTIONS_AND_DEFINITIONS)
  ...
  IF(EMSCRIPTEN)
    ...
    EXECUTE_PROCESS(COMMAND ${PYTHON_EXECUTABLE} embuilder.py build zlib
                    WORKING_DIRECTORY ${EMSCRIPTEN_ROOT_PATH})

    SET(EM_COMPILER_FLAGS "-s USE_ZLIB=1 -Wno-warn-absolute-paths")
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${EM_COMPILER_FLAGS}")
    TALIPOT_SET_CXX_FLAGS("${EM_COMPILER_FLAGS}")
...
MACRO(TALIPOT_ADD_PLUGIN)
  ...
  CMAKE_PARSE_ARGUMENTS(PLUGIN "" "NAME;INSTALL_DIR" "SRCS;LINKS" ${ARGN})
