...
#ifndef TALIPOT_PLUGIN_H
#define TALIPOT_PLUGIN_H
 ...
 *
 * This class also holds extra information about the Talipot system such as the library version the
 ...
 * This macro is mandatory in order to register a plugin into Talipot. This will generate a Factory
...
PLUGIN(MyPlugin) // Register MyPlugin into Talipot
@endcode
 *
 * @see tlp::Plugin
