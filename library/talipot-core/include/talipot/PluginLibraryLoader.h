...
class TLP_SCOPE PluginLibraryLoader {
  public:
    ...
    * @param loader A PluginLoader to output what is going on. Defaults to nullptr.
    * @param userLocalPath A user specific local directory where some plugins may have been
    downloaded
    ...
    **/
     ...
     * @param loader A loader to report what is going on (only its loaded or aborted functions will
     *be called) Defaults to nullptr.
