...
private:
  ...
  typedef tlp_hash_map_safe<Face, std::vector<edge>> faceMap;
  typedef faceMap::value_type faceMapEntry;
  typedef tlp_hash_map_safe<edge, std::vector<Face>> edgeMap;
  typedef edgeMap::value_type edgeMapEntry;
  typedef tlp_hash_map_safe<node, std::vector<Face>> nodeMap;
