...
#ifndef TALIPOT_TLPB_EXPORT_IMPORT_H
#define TALIPOT_TLPB_EXPORT_IMPORT_H
...
/**
 * The plugins below export/import a Talipot graph
...
/**
 *
 * \brief This plugin saves a Talipot graph using a binary format
 *
 */
...
/**
 *
 * \brief This plugin reads a Talipot graph using a binary format
 *
 */
...
#endif // TALIPOT_TLPB_EXPORT_IMPORT_H
