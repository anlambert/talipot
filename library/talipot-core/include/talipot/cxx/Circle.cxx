...
tlp::Circle<Obj, OTYPE> tlp::enclosingCircle(const std::vector<tlp::Circle<Obj, OTYPE>> &circles) {
    class OptimumCircleHull {
        ...
        static tlp::Circle<Obj, OTYPE> enclosingCircle(const tlp::Circle<Obj, OTYPE> &c1,
            ...
            Obj r3 = c3.radius;
            Obj b =
                -b1 * r2 * a1 * a1 * b3 + a3 * a3 * r2 * r2 * r2 + b2 * b2 * r3 * r3 * r3 +
            ...
            Obj d = sqrt((a2 * a2 + b2 * b2 - r2 * r2 - 2 * a2 * a3 + a3 * a3 - r3 * r3 -
                          2 * b3 * b2 + b3 * b3 + 2 * r3 * r2) *
                         (b3 * b3 + b1 * b1 - r1 * r1 - r3 * r3 - 2 * b1 * b3 + 2 * r3 * r1 +
                          a3 * a3 - 2 * a1 * a3 + a1 * a1) *
                         (a1 * a1 - 2 * a1 * a2 - r1 * r1 + b1 * b1 + b2 * b2 - r2 * r2 -
                          2 * b2 * b1 + 2 * r2 * r1 + a2 * a2) *
                         tmp * tmp);
            Obj v = d - b;
        ...
        void process2() {
            if (isEmpty()) {
                ...
                if (!(*circles)[selectedCircle].isIncludeIn(result)) {
                    result =
                        enclosingCircle((*circles)[b1], (*circles)[b2], (*circles)[selectedCircle]);
