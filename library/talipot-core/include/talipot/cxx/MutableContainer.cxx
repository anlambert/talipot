...
public:
  IteratorHash(const TYPE &value, bool equal,
               tlp_hash_map<INDEX_TYPE, typename tlp::StoredType<TYPE>::Value> *hData)
...
private:
  ...
  bool _equal;
  tlp_hash_map<INDEX_TYPE, typename tlp::StoredType<TYPE>::Value> *hData;
  typename tlp_hash_map<INDEX_TYPE, typename tlp::StoredType<TYPE>::Value>::const_iterator it;
};
...
void tlp::MutableContainer<TYPE, INDEX_TYPE>::vecttohash() {
  hData = new tlp_hash_map<INDEX_TYPE, typename StoredType<TYPE>::Value>(elementInserted);
