...
class AbstractProperty : public PropType {
  ...
  public:
    ...
    /**
     * @brief This class is used to delegate the computation of the values associated to meta nodes
     *or edges.
     **/
    class TLP_SCOPE MetaValueCalculator : public PropertyInterface::MetaValueCalculator {
      public:
        ...
        virtual void computeMetaValue(AbstractProperty<NodeType, EdgeType, PropType> *, node,
                                      Graph *, Graph *);
...
class AbstractVectorProperty : public AbstractProperty<VecType, VecType, PropType> {
  public:
    ...
    /**
     * @brief Sets the value for node n, at index i, to v, and notify the observers of a
     *modification.
     *
    ...
    void resizeNodeValue(const node n, size_t size,
                         REAL_TYPE(EltType) elt = EltType::defaultValue());
    /**
     * @brief Sets the value for edge e, at index i, to v, and notify the observers of a
     *modification.
     *
     * @param e The edge to set the value of.
     * @param i The index at which the value should be set.
