...
#ifndef TALIPOT_PLANARITY_TEST_IMPL_H
#define TALIPOT_PLANARITY_TEST_IMPL_H
...
private:
  ...
  tlp_hash_map_safe<edge, edge> bidirectedEdges;
  tlp_hash_map_safe<edge, edge> reversalEdge;
  ...
  tlp_hash_map_safe<node, std::list<node>> childrenInT0;
  ...
  tlp_hash_map_safe<node, BmdList<edge>> embedList;

  // to avoid path compression of c-nodes;
  tlp_hash_map_safe<tlp::BmdLink<node> *, node> activeCNode;
