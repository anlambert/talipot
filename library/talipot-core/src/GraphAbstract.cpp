...
void GraphAbstract::notifyBeforeRenameLocalProperty(PropertyInterface *prop,
    ...
    if (hasOnlookers()) {
        sendEvent(
            GraphEvent(*this, GraphEventType::TLP_BEFORE_RENAME_LOCAL_PROPERTY, prop, newName));
    }
}
//=========================================================================
void GraphAbstract::notifyAfterRenameLocalProperty(PropertyInterface *prop,
    ...
    if (hasOnlookers()) {
        sendEvent(
            GraphEvent(*this, GraphEventType::TLP_AFTER_RENAME_LOCAL_PROPERTY, prop, oldName));
    }
}
//=========================================================================
