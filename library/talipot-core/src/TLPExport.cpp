...
public:
  PLUGININFORMATION(
      ...
      "Software Graph Format).<br/>See https://tulip.labri.fr/site/?q=tlp-file-format "
  ...
  TLPExport(tlp::PluginContext *context) : ExportModule(context), progress(0) {
    addInParameter<string>("name", paramHelp[0].data(), "");
    addInParameter<string>("author", paramHelp[1].data(), "");
    addInParameter<string>("text::comments", paramHelp[2].data(),
                           "This file was generated by Talipot.");
  }
  //=====================================================
