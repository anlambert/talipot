...
void GraphUpdatesRecorder::recordIncidence(tlp_hash_map<node, std::vector<edge>> &incidences,
...
void GraphUpdatesRecorder::removeFromIncidence(tlp_hash_map<node, std::vector<edge>> &incidences,
                                               edge e, node n) {
