...
protected:
  tlp_hash_map<std::string, uint> valueToId;
  tlp::Graph *graph;
...
private:
  tlp::Graph *graph;
  tlp_hash_map<std::string, uint> srcValueToId;
  tlp_hash_map<std::string, uint> tgtValueToId;
...
private:
  ...
  tlp_hash_map<uint, tlp::PropertyInterface *> propertiesBuffer;
