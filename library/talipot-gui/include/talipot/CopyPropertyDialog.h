...
class TLP_QT_SCOPE CopyPropertyDialog : public QDialog {
  ...
  public:
    ...
    /**
     * @brief Init dialog with required parameters. To make the copy this dialog need to have a
     *valid source property and destination graph.
     **/
     ...
     *Observable::holdObserver and Observable::unholdObserver before and after calling this
     *function.
     **/
