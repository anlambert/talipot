...
#ifndef TALIPOT_VIEW_H
#define TALIPOT_VIEW_H
...
class TLP_QT_SCOPE View : public QObject, public tlp::Plugin, public tlp::Observable {
  ...
  public:
    /**
      ...
      @warning Code of this method should almost be a no-op. Subsequent calls on other methods
      should allow you to setup your view.
      */
    View();
    ...
    /**
      ...
      Since several widgets can be retrieved, user will be able to select them from a combo box
      where each widget will be identified by its windowsTitle.
  ...
  public slots:
    /**
     * @brief This method is a callback to notify the panel that the pop() method (undo) has just
     *been called on the graph. By default, this method will make a call to centerView()
     **/
    virtual void undoCallback();

    /**
      @brief This method applies settings changed in the configuration widgets
      This method may be called from the overleying system in various situations. The View is
      expected to apply settings in an optimized way to prevent extra redraws. By default, this
      method does nothing.
      */
    ...
    /**
      ...
      This method is called after major changes into the data structure. At this point, the user
      point of view should be reset and brought back to a point where all the data can be seen.
    ...
    */
    ...
    /**
      ...
      Calling refresh() means that no internal data has been modified. This can happen when the
      view's panel gets resized, restored etc
      */
    ...
    /**
      ...
      Triggers are tlp::Observable subclasses. Once registered, the view will listen to the
      trigger's events and emit the drawNeeded signal each time the Observable::treatEvents()
      callback is run. For more information about the Observable system, @see tlp::Observable
      ...
      @warning If your tlp::View subclass overloads the treatEvents method. You must make sure to
      call the View::treatEvents method in order to keep the triggers system working.
      */
    ...
    /**
      ...
      @note From the moment this method is called, no update on previous triggers will be
      considered. Even if this is called during an Observable::holdObservers()
      */
  ...
  protected slots:
    ...
    /**
      ...
      active interactor.
      @warning The interactor passed down to this method MAY BE a nullptr pointer ! This means that
      no current interactor should be set.
      */
     ...
     * @param QMenu The popup menu that will be displayed. This menu should be populated with
     * context action related to the panel.
     */
