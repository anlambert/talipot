...
Workspace::Workspace(QWidget *parent)
    ...
    // This map allows us to know how much slots we have for each mode and which widget corresponds
    // to those slots
...
void Workspace::writeProject(Project *project, QMap<Graph *, QString> rootIds,
    ...
    for (auto *v : panels()) {
        ...
        project->mkpath(path);
        // get view state. Do this before the rest in case state() changes some parameters inside
        // the view
