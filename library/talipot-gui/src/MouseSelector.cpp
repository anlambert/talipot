                ...
                if (result) {
                    ...
                    case SelectedEntity::NODE_SELECTED:
                        ...
                        if (_mode == EdgesAndNodes || _mode == NodesOnly) {
                            result =
                                selection->getNodeValue(node(selectedEntity.getGraphElementId()));
                            ...
                            if (revertSelection || boolVal != result) {
                                ...
                                selection->setNodeValue(node(selectedEntity.getGraphElementId()),
                                                        !result);
                            }
                        }
                    ...
                    case SelectedEntity::EDGE_SELECTED:
                        ...
                        if (_mode == EdgesAndNodes || _mode == EdgesOnly) {
                            result =
                                selection->getEdgeValue(edge(selectedEntity.getGraphElementId()));
                            ...
                            if (revertSelection || boolVal != result) {
                                ...
                                selection->setEdgeValue(edge(selectedEntity.getGraphElementId()),
                                                        !result);
                            }
                        }
                ...
                if (_mode == EdgesAndNodes || _mode == NodesOnly) {
                    for (const auto &entity : tmpSetNode) {
                        selection->setNodeValue(node(entity.getGraphElementId()),
                                                revertSelection ? !selection->getNodeValue(node(
                                                                      entity.getGraphElementId()))
                                                                : boolVal);
                    }
                }
                ...
                if (_mode == EdgesAndNodes || _mode == EdgesOnly) {
                    for (const auto &entity : tmpSetEdge) {
                        selection->setEdgeValue(edge(entity.getGraphElementId()),
                                                revertSelection ? !selection->getEdgeValue(edge(
                                                                      entity.getGraphElementId()))
                                                                : boolVal);
                    }
                }
