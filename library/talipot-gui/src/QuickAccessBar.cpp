...
QuickAccessBarImpl::QuickAccessBarImpl(QGraphicsItem *quickAccessBarItem,
    ...
    connect(_ui->showEdgesToggle, &QPushButton::clicked, this,
            &QuickAccessBarImpl::setEdgesVisible);
    ...
    connect(_ui->showNodesToggle, &QPushButton::clicked, this,
            &QuickAccessBarImpl::setNodesVisible);
...
GlGraphRenderingParameters *QuickAccessBar::renderingParameters() const {
    return &scene()->glGraph()->renderingParameters();
}

GlGraphInputData *QuickAccessBar::inputData() const {
    return scene()->glGraph()->inputData();
}
