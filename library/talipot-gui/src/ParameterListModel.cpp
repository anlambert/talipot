...
static QIcon bracketIcon() {
    QPixmap pixmap = FontIcon::icon(MaterialDesignIcons::CodeBrackets, QColor(Qt::darkGray), 1.4)
                         .pixmap(128, 128);
...
static QIcon outputIcon() {
    return FontIcon::stackIcons(
        bracketIcon(), FontIcon::icon(MaterialDesignIcons::ArrowLeftBold, QColor(Qt::red)));
}

static QIcon inputOutputIcon() {
    static const QIcon rightArrow = FontIcon::icon(MaterialDesignIcons::ArrowRightBold,
