...
class TLP_GL_SCOPE GlLabel final : public GlEntity {
  ...
  public:
     ...
     * This function is useful when you have an entity : you specify the size of the position of
     * this entity and you tell that you want a label outside this entity
     * @see LabelPosition
