...
#ifndef TALIPOT_GL_AXIS_H
#define TALIPOT_GL_AXIS_H
...
class TLP_GL_SCOPE GlAxis : public GlComposite {
  ...
  public:
     ...
     * @param axisBaseCoord the base coord of the axis (if the axis is horizontal, it is the the
     * left end, if vertical it is the down end)
     ...
     * method.
     *
     * @param captionPos the relative position of the caption. Two possible values : LEFT_OR_BELOW
     * (if the axis is vertical, caption will be below of the axis, otherwise on the left) or
     * RIGHT_OR_ABOVE
     ...
     * @param captionOffset fill this parameter if you want to fix the offset between the axis and
     * the caption
