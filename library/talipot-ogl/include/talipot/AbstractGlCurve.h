...
protected:
  ...
  static tlp_hash_map<uint, std::vector<GLfloat>> curveVertexBuffersData;
  static tlp_hash_map<uint, std::vector<std::vector<GLushort>>> curveVertexBuffersIndices;
  static tlp_hash_map<uint, std::vector<GLuint>> curveVertexBuffersObject;
  static tlp_hash_map<std::string, std::unique_ptr<GlShaderProgram>> curvesShadersMap;
  static tlp_hash_map<std::string, std::unique_ptr<GlShaderProgram>> curvesBillboardShadersMap;
  static bool canUseGeometryShader;
  static tlp_hash_map<std::string,
                      std::pair<std::unique_ptr<GlShaderProgram>, std::unique_ptr<GlShaderProgram>>>
