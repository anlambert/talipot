...
class TLP_GL_SCOPE GlNominativeAxis : public GlAxis {
  ...
  public:
     ...
     * \param labelsPosition the relative position of the axis graduations label. Two possible
     * values : LEFT_OR_BELOW (if the axis is vertical, labels will be on the left of the axis,
     * otherwise below) or RIGHT_OR_ABOVE
     */
