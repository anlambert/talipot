...
class TLP_GL_SCOPE GlPolyQuad : public GlEntity {
  ...
  public:
     ...
     *
     * Pay attention to the order of the edges point in the polyQuadEdges vector. Indeed, to draw
     * the following polyquad
     *
     *                    v2
     *          v0+--------+--------+ v4
     *            |        |        |
     ...
     *                    v3
     *
     * The content of the polyQuadEdges vector should be {v0, v1, v2, v3, v4, v5} or {v1, v0, v3,
     * v2, v5, v4}
     *
     * \param polyQuadEdges A vector containing the coordinates of the quad edges, its size must be
     * a multiple of 2 because an edge is defined by 2 points \param polyQuadEdgesColor A vector
     * containing the edges's colors, its size must be equal to the number of edges defined by the
     * polyQuadEdges vector \param  textureName The absolute path of the texture image file to use
     */
    GlPolyQuad(const std::vector<Coord> &polyQuadEdges,
               const std::vector<Color> &polyQuadEdgesColor, const std::string &textureName = "",
     ...
     *
     * \param polyQuadEdges A vector containing the coordinates of the quad edges, its size must be
     * a multiple of 2 because an edge is defined by 2 points \param polyQuadColor The polyquad
     * color \param  textureName The absolute path of the texture image file to use
     */
