...
tlp_hash_map<uint, vector<GLfloat>> AbstractGlCurve::curveVertexBuffersData;
tlp_hash_map<uint, vector<vector<GLushort>>> AbstractGlCurve::curveVertexBuffersIndices;
tlp_hash_map<uint, vector<GLuint>> AbstractGlCurve::curveVertexBuffersObject;
tlp_hash_map<string, unique_ptr<GlShaderProgram>> AbstractGlCurve::curvesShadersMap;
tlp_hash_map<string, unique_ptr<GlShaderProgram>> AbstractGlCurve::curvesBillboardShadersMap;
bool AbstractGlCurve::canUseGeometryShader = false;
tlp_hash_map<std::string, std::pair<unique_ptr<GlShaderProgram>, unique_ptr<GlShaderProgram>>>
