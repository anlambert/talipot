...
set_property(TARGET ${OGDFLibrary} PROPERTY VERSION ${PROJECT_VERSION})
target_link_libraries(${OGDFLibrary} PUBLIC COIN)
group_files(ogdf_sources "ogdf")
group_files(ogdf_headers "ogdf")
target_compile_features(${OGDFLibrary} PUBLIC cxx_std_${CMAKE_CXX_STANDARD})
...
if(BUILD_SHARED_LIBS)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    target_compile_options(${OGDFLibrary} PRIVATE "-fvisibility=hidden" "-fvisibility-inlines-hidden")
  endif()
endif()
...
if(has_sse3_intrin)
  ...
  if(NOT MSVC)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -sse3")
  endif(NOT MSVC)
...
if(OGDF_USE_ASSERT_EXCEPTIONS_WITH_STACK_TRACE STREQUAL "ON_LIBDW")
  target_link_libraries(${OGDFLibrary} PUBLIC Libdw)
elseif(OGDF_USE_ASSERT_EXCEPTIONS_WITH_STACK_TRACE STREQUAL "ON_LIBBFD")
  target_link_libraries(${OGDFLibrary} PUBLIC Libbfd)
elseif(OGDF_USE_ASSERT_EXCEPTIONS_WITH_STACK_TRACE STREQUAL "ON_LIBUNWIND")
  target_link_libraries(${OGDFLibrary} PUBLIC Libunwind)
endif()
...
# install(TARGETS ${OGDFLibrary} EXPORT OgdfTargets COMPONENT OGDF) # add the OGDF target to the export set "OgdfTargets"
