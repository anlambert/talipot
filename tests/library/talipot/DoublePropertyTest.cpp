...
void DoublePropertyTest::testDoublePropertyMinUpdate() {
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("test DoubleProperty min value before update", originalMin,
                                 minNode);
...
void DoublePropertyTest::testDoublePropertyMaxUpdate() {
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("test DoubleProperty max value before update", originalMax,
                                 maxNode);
