...
class TestAlgorithm(tlp.Algorithm):
    def __init__(self, context):
        ...
        self.addBooleanParameter(
            boolean_param_name, defaultValue=str(boolean_param_default_value)
        )

        self.addColorParameter(color_param_name, defaultValue=color_param_default_value)

        self.addColorScaleParameter(
            color_scale_param_name, defaultValue=color_scale_param_default_value
        )

        self.addIntegerParameter(
            int_param_name, defaultValue=str(int_param_default_value)
        )

        self.addFloatParameter(
            float_param_name, defaultValue=str(float_param_default_value)
        )

        self.addStringParameter(
            string_param_name, defaultValue=str(string_param_default_value)
        )
        ...
        self.addBooleanPropertyParameter(
            boolean_prop_param_name, defaultValue=boolean_prop_param_default_value
        )

        self.addColorPropertyParameter(
            color_prop_param_name, defaultValue=color_prop_param_default_value
        )

        self.addDoublePropertyParameter(
            double_prop_param_name, defaultValue=double_prop_param_default_value
        )

        self.addIntegerPropertyParameter(
            int_prop_param_name, defaultValue=int_prop_param_default_value
        )

        self.addLayoutPropertyParameter(
            layout_prop_param_name, defaultValue=layout_prop_param_default_value
        )

        self.addSizePropertyParameter(
            size_prop_param_name, defaultValue=size_prop_param_default_value
        )

        self.addStringPropertyParameter(
            string_prop_param_name, defaultValue=string_prop_param_default_value
        )
        ...
        self.addColorVectorPropertyParameter(
            color_vec_prop_param_name, defaultValue=color_vec_prop_param_default_value
        )

        self.addDoubleVectorPropertyParameter(
            double_vec_prop_param_name, defaultValue=double_vec_prop_param_default_value
        )

        self.addIntegerVectorPropertyParameter(
            int_vec_prop_param_name, defaultValue=int_vec_prop_param_default_value
        )

        self.addCoordVectorPropertyParameter(
            coord_vec_prop_param_name, defaultValue=coord_vec_prop_param_default_value
        )

        self.addSizeVectorPropertyParameter(
            size_vec_prop_param_name, defaultValue=size_vec_prop_param_default_value
        )

        self.addStringVectorPropertyParameter(
            string_vec_prop_param_name, defaultValue=string_vec_prop_param_default_value
        )
...
class TestPluginParameters(unittest.TestCase):
    ...
    def test_plugin_default_parameters(self):
        ...
        self.assertEqual(
            plugin_default_params[boolean_param_name], boolean_param_default_value
        )
        ...
        self.assertTrue(
            isinstance(plugin_default_params[color_scale_param_name], tlp.ColorScale)
        )

        self.assertEqual(
            plugin_default_params[color_scale_param_name],
        ...
        self.assertEqual(
            plugin_default_params[string_param_name], string_param_default_value
        )
        ...
        self.assertEqual(
            plugin_default_params[string_collection_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[boolean_prop_param_name], tlp.BooleanProperty
            )
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(plugin_default_params[color_prop_param_name], tlp.ColorProperty)
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[double_prop_param_name], tlp.DoubleProperty
            )
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(plugin_default_params[int_prop_param_name], tlp.IntegerProperty)
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[layout_prop_param_name], tlp.LayoutProperty
            )
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(plugin_default_params[size_prop_param_name], tlp.SizeProperty)
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[string_prop_param_name], tlp.StringProperty
            )
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[boolean_vec_prop_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[color_vec_prop_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[double_vec_prop_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[int_vec_prop_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[coord_vec_prop_param_name],
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[size_vec_prop_param_name], tlp.SizeVectorProperty
            )
        )
        self.assertEqual(
        ...
        self.assertTrue(
            isinstance(
                plugin_default_params[string_vec_prop_param_name],
    ...
    def test_plugin_in_parameters(self):
        ...
        self.assertEqual(parameters_value[string_param_name], string_param_value)
        self.assertEqual(
            parameters_value[string_collection_param_name],
            string_collection_param_value,
        )
        self.assertEqual(parameters_value[color_param_name], color_param_value)
        self.assertEqual(
            parameters_value[color_scale_param_name], color_scale_param_value
        )
        ...
        self.assertEqual(
            parameters_value[boolean_vec_prop_param_name], self.boolean_vec_prop
        )
        self.assertEqual(
            parameters_value[color_vec_prop_param_name], self.color_vec_prop
        )
        self.assertEqual(
            parameters_value[double_vec_prop_param_name], self.double_vec_prop
        )
        self.assertEqual(parameters_value[int_vec_prop_param_name], self.int_vec_prop)
        self.assertEqual(
            parameters_value[coord_vec_prop_param_name], self.coord_vec_prop
        )
        self.assertEqual(parameters_value[size_vec_prop_param_name], self.size_vec_prop)
        self.assertEqual(
            parameters_value[string_vec_prop_param_name], self.string_vec_prop
        )
