...
void InteractorParallelCoordsSelection::construct() {
    setConfigurationWidgetText(
        ...
        "area.</p>" +
        "<p>To <b>insert new elements</b> in the current selection, hold the <b>control key</b> "
        "and "
        "click on the new elements to add.</p>" +
        "<p>To <b>remove elements</b> in the current selection, hold the <b>shift key</b> and "
        "click "
...
void InteractorHighLighter::construct() {
    setConfigurationWidgetText(
        ...
        "configuration tab (setting this value to 0 will make the non highlighted elements "
        "disappear "
        "from drawing). </p>" +
        "<p>By <b>left clicking</b> in the drawing, all the elements under the mouse pointer will "
        "be "
        "highlighted.</p>" +
        "<p>It is also possible to <b>define a rectangular area by doing a left click and holding "
        "it</b> while moving the mouse. By releasing the mouse left button, all the elements "
        "located "
        ...
        "<p>To reset the set of highlighted elements, position the mouse cursor so that there is "
        "no "
        "elements under it and do a left click. This operation can also be done by right clicking "
        "in "
        "the drawing and select the \"Reset highlighting of elements\" entry in the popup menu "
        "which "
        "appears.</p>" +
...
void InteractorAxisSwapper::construct() {
    setConfigurationWidgetText(
        ...
        "is under the axis, do a left click and keep the mouse button pressed while you're "
        "dragging "
        "the axis. To swap the axis with an other, release the mouse button when a translucent "
        "green "
...
void InteractorAxisSliders::construct() {
    setConfigurationWidgetText(
        ...
        "<p>To use the axis sliders, <b>put the mouse pointer under the slider you want to "
        "move</b> "
        "(its outline color will change), do a <b>left-click and drag the slider along the "
        "axis</b>. "
        ...
        "<p>It is also possible to <b>drag the range defined by two axis sliders</b>, by putting "
        "the "
        "mouse pointer between them (a translucent rectangle will appear) and drag and drop it "
        "along "
        "the axis.</p>" +
        "<p>It is possible to filter the current highlighted elements set on other dimensions. To "
        "do "
        ...
        "will be applied on the result of the previous ones if any, not on the entire "
        "dataset.</p>" +
        "<p>It is also possible to add elements to the current highlighted elements set. By "
        "holding "
        "the <b>shift key</b> while using a slider (all sliders will be colored in light green "
        "when "
...
void InteractorBoxPlot::construct() {
    setConfigurationWidgetText(
        ...
        "(Q1), median (Q2), third (Q3), and the top outlier). The image below illustrates the way "
        "to "
        "read a box plot.</p>" +
        "<p>" +
...
void InteractorAxisSpacer::construct() {
    setConfigurationWidgetText(
        ...
        "<p>Put the mouse pointer under an axis, a red rectangle will appear to indicate the axis "
        "is "
        "selected. Do a left click and keep the mouse button pressed while you're dragging the "
        "axis "
        "to modify its position. The axis can not be moved further that its neighbors.</p>" +
        "<p>By double clicking anywhere in the view, the axis positions will be reset to the "
        "default "
        "ones and the axis will we equally spaced.</p>" +
        "<p>The axis positions will also be reset to default when the number of selected "
        "dimensions "
        "changes.</p>" +
        "</body>" + "</html>");
    push_back(new MousePanNZoomNavigator);
