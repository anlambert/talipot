...
class SOMView : public GlView {
    ...
    PLUGININFORMATION(
        ...
        "representation."
        "<p>Self organizing maps operate in two modes: training and mapping.<ul><li>Training "
        "builds "
  ...
  public:
    ...
    /**
     * Return the ColorProperty pointer for the selected property. Return nullptr if no properties
     * are selected.
     * @return
     */
    ...
    /**
     * Add a mask on the som. All the nodes in the set will be printed with right color others will
     * be printed in gray.
     * @param mask
     */
  ...
  private:
    ...
    /**
     * Function used to create and fill a ColorProperty corresponding to a NumericProperty in the
     * SOM.
    ...
    /**
     * Compute a ColorProperty object from a DoubleProperty in the SOM. Get the min and the max
     * value of the SOM double property.
     * @param SOM the map.
