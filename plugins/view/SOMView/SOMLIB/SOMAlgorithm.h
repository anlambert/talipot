...
class SOMAlgorithm {
  public:
    /**
     * Build the SOMAlgorithm object used to compute Self Organizing Map with the given time and
     * space function.
     * @param learningRateFunction The function used to compute the learning rate in function of
     * time.
    ...
    /**
     * Init the given SOM with the given sample. At this time set all the weight node of the map
     * with a weight take randomly in the input sample.
     * @param map The SOM
    ...
    /**
     * Train the SOM with the given sample. Use numberOfIteration time the entire inputSample to
     * train the SOM. See the train function for more details.
     * @param map The SOM.
    ...
    /**
     * Propagate modification on the SOM. Compute the learning coefficient in function of the
     * current iteration and the distance between the first updated node and the modified one.
    ...
    /**
     * Function use to automatically perform initialisation and training on a SOM with a given
     * sample of vector.
     * @param map The SOM.
     * @param inputSample
