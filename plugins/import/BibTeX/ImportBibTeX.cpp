  ...
  public:
    ...
    ImportBibTeX(const PluginContext *context) : ImportModule(context) {
        ...
        addInParameter<StringCollection>(
            "Nodes to import",
            "The type of nodes to create: <b>Authors</b> (Create nodes for authors only, "
            "publications "
            "are represented as edges between authors)<br/><b>Authors and Publications</b> (Create "
            "nodes for both authors and publications and edges are created between the "
            "publications "
        ...
        addInParameter<bool>(
            ...
            "<b>true</b>, that a new edge will be created each time two authors are involved in "
            "the "
            ...
            "publications</b> property edge value will indicate the number of publications they "
            "wrote "
            "in common.</li></ul>",
            "true", false);
    }
    ...
    bool importGraph() override {
                    ...
                    if (isAuthor) {
                        ...
                        if (createPubliNodes) {
                            ...
                            if (authorNodes.empty()) {
                                warning() << "Warning: found the publication '" << key.c_str()
                                          << "' without author" << endl;
        ...
        if (!result) {
            ...
            string err;
            graph->applyPropertyAlgorithm("FM^3 (OGDF)", graph->getLayoutProperty("viewLayout"),
