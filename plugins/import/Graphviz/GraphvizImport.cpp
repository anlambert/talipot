...
public:
  ...
  bool importGraph() override {
    ...
    tlp_hash_map<string, NodeShape::NodeShapes> shapeMap = {
    ...
    tlp_hash_map<string, SetNodePropertyFunc> setNodePropertyMap;
    ...
    tlp_hash_map<string, SetEdgePropertyFunc> setEdgePropertyMap;
    ...
    tlp_hash_map<Agnode_t *, node> nodeMap;
