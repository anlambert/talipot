...
//====================================================================
OrientableSizeProxy::PointType OrientableSizeProxy::getNodeValue(const tlp::node n) const {
  return OrientableSize(const_cast<OrientableSizeProxy *>(this), (*sizesProxy)[n]);
}
...
OrientableSizeProxy::LineType OrientableSizeProxy::getEdgeValue(const tlp::edge e) {
  return OrientableSize(this, (*sizesProxy)[e]);
}
