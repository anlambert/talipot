  ...
  public:
    ...
    OGDFStressMinimization(const tlp::PluginContext *context)
        : OGDFLayoutPluginBase(context,
                               tlp::getOGDFLayoutModule<ogdf::StressMinimization>(context)) {
        ...
        addInParameter<tlp::NumericProperty *>("edgeCostsProperty", paramHelp[8].data(),
                                               "viewMetric");
        ...
        if (dataSet != nullptr) {
            ...
            if (dataSet->get("terminationCriterion", sc)) {
                if (sc.getCurrentString() == "PositionDifference") {
                    ...
                    stressm->convergenceCriterion(
                        ogdf::StressMinimization::TerminationCriterion::Stress);
                } else {
                    stressm->convergenceCriterion(
                        ogdf::StressMinimization::TerminationCriterion::None);
                }
            }
