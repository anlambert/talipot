...
void RectanglePacking::
    ...
    for (itRectOfSequenceAlreadyRepositionned = itFirstRectangleRightOrAboveOfNewRectangle;
        ...
        if (placesOfRectanglesInSecondSequence
            ...
            if ((highOrdinate =
                     itRectOfSequenceAlreadyRepositionned->rectangleTemporaryLowOrdinate +
            ...
            if ((rightAbscissa =
                     itRectOfSequenceAlreadyRepositionned->rectangleTemporaryLeftAbscissa +
...
int RectanglePacking::calculOfNumberOptimalRepositionnedRectangles(const char *quality) const {
    ...
    if (!strcmp(quality, "n5")) {
        ...
        return int(
            floor(pow(pow(numberOfRectanglesDouble, 4.0) * log(numberOfRectanglesDouble), 0.2)));
        ...
        return int(
            floor(pow(pow(numberOfRectanglesDouble, 3.0) * log(numberOfRectanglesDouble), 0.2)));
        ...
        return int(
            floor(pow(pow(numberOfRectanglesDouble, 2.0) * log(numberOfRectanglesDouble), 0.2)));
